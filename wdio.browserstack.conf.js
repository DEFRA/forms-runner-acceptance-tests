...
export const config = {
  ...
  baseUrl: `https://forms-runner-acceptance-tests.${process.env.ENVIRONMENT}.cdp-int.defra.cloud`,
  ...
  commonCapabilities: {
    'bstack:options': {
      buildName: `forms-runner-acceptance-tests-${process.env.ENVIRONMENT}` // configure as required
    }
  },
    ...
    [
      'browserstack',
      {
        ...
        testObservabilityOptions: {
          ...
          buildName: `forms-runner-acceptance-tests-${process.env.ENVIRONMENT}`
        },
